...
describe('NotificationItem', () => {
    ...
    test('markAsRead function is called with the correct id on click', () => {
      const mockMarkAsRead = jest.fn();
      const notificationItem =new NotificationItem({markAsRead: mockMarkAsRead});
      notificationItem.props.markAsRead(notificationItem.id);
      expect(mockMarkAsRead).toHaveBeenCalledWith(notificationItem.id);
    });
});
