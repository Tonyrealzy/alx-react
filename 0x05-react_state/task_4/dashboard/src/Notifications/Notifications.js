            ...
            <div className={css(menuStyles.menuItem)}>
                ...
                <div className={css(styles.Notifications)}>
                    <aside style={{ display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        >
                            <img src={CloseIcon} style={{ height: '0.5rem', border: 'none' }} alt='close icon' onClick={handleHideDrawer} />
                        </button>
                    </aside>
                    ...
                    <NotificationItem key={notifications.id} value={notifications.value} onClick={() => markNotificationAsRead(notifications.id)} />
                    )))
                    }
                </div>
                }
