...
function Login() {
  return (
    <div className={css(styles.appBody, styles.appBodyResp)}>
      ...
      <aside>
        <form className={css(styles.form, styles.formResp)}>
          <section>
            ...
            <input type='email' className={css(styles.email, styles.emailResp)} />
          </section>
          ...
          <section>
            ...
            <input type='password' className={css(styles.password, styles.passwordResp)} />
          </section>

          <button className={css(styles.button, styles.buttonResp)}>OK</button>
        </form>
      </aside>
